...
public class LoadingBox implements LoadingBoxInterface {
    ...
    // other error
    private final int errorImageResoruce;
    ...
    private final LoadingBoxInterface.OnClickListener onNetworkErrorRetryClickListener;
    private final String errorRetryText;
    private final LoadingBoxInterface.OnClickListener onErrorRetryClickListener;
    private final String emptyTodoText;
    private final LoadingBoxInterface.OnClickListener onEmptyTodoClickListener;
    ...
    private LoadingBox(Builder builder) {
...
//        }
//
//        if (!StringUtils.isEmpty(emptyTodoText)) {
...
//        showView(emptyView);
    ...
    public static class Builder{
        ...
        private LoadingBoxInterface.OnClickListener onNetworkErrorRetryClickListener;
        private String errorRetryText;
        private LoadingBoxInterface.OnClickListener onErrorRetryClickListener;
        private String emptyTodoText;
        private LoadingBoxInterface.OnClickListener onEmptyTodoClickListener;
        ...
        public Builder setOnNetworkErrorRetryClickListener(LoadingBoxInterface.OnClickListener listener) {
            this.onNetworkErrorRetryClickListener = listener;
            return this;
        }

        public Builder setOnNetworkErrorRetryClickListener(String networkErrorRetryText, LoadingBoxInterface.OnClickListener listener) {
            this.networkErrorRetryText = networkErrorRetryText;
            this.onNetworkErrorRetryClickListener = listener;
            return this;
        }

        public Builder setOnErrorRetryClickListener(LoadingBoxInterface.OnClickListener listener) {
            this.onErrorRetryClickListener = listener;
            return this;
        }

        public Builder setOnErrorRetryClickListener(String errorRetryText, LoadingBoxInterface.OnClickListener listener) {
            this.errorRetryText = errorRetryText;
            this.onErrorRetryClickListener = listener;
            return this;
        }

        public Builder setOnEmptyTodoClickListener(LoadingBoxInterface.OnClickListener listener) {
            this.onEmptyTodoClickListener = listener;
            return this;
        }

        public Builder setOnEmptyTodoClickListener(String emptyTodoText, LoadingBoxInterface.OnClickListener listener) {
            this.emptyTodoText = emptyTodoText;
            this.onEmptyTodoClickListener = listener;
            return this;
        }

        public LoadingBox build() {
            return new LoadingBox(this);
        }
    }
}
